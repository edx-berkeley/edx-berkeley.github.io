...
export default function HomePage() {
  return (
    <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-14 sm:px-6">
      ...
      <section aria-labelledby="courses-heading" className="mx-auto mt-20 max-w-5xl">
      ...
      <section aria-labelledby="edx-structure-heading" className="mx-auto mt-20 max-w-3xl">
        ...
        <div className="mt-8 space-y-8 text-zinc-600">
          ...
          <div className="space-y-3">
            ...
            <p className="leading-relaxed">
              ...
              {" "}and search for the course (for example &ldquo;C88C,&rdquo; &ldquo;88B,&rdquo; or &ldquo;88E&rdquo;) or for{" "}
              &ldquo;UC Berkeley.&rdquo; You can take these courses for free (audit) and get full access to the content. If you want a verified certificate, you have to pay the certificate fee on edX. Content is the same either way; payment is only for the credential.
            </p>
          </div>
        </div>
      </section>
